GHI CHÚ 1: Xin vui lòng không sao chép nội dung của trang này vào blog của bạn. Bạn có thể chia sẻ trang này, nhưng vui lòng chia sẻ với link gốc. Đó là cách chúng ta tôn trọng tác giả của các tài liệu hay và các dự án mã nguồn mở.

GHI CHÚ 2: Xin lưu ý rằng lập trình bậc thấp hiện đã lỗi thời và không có nhiều công ty tuyển dụng lập trình viên phần cứng(Low-level developer). Quá trình kiếm việc cũng ngày càng khó khăn hơn với tôi. Nếu bạn chưa bước chân vào công việc chuyên môn, tôi đề xuất bạn cân nhắc kĩ lưỡng các lĩnh vực, chuyên ngành khác. 

GHI CHÚ 3: Nếu bạn muốn bắt đầu ngay lập tức, hãy xem [How to start?](#How-to-start) phía dưới.

* [Tổng quan về lập trình bậc thấp](#Tổng-quan-về-lập-trình-bậc-thấp)
  * [Nó là gì?](#Nó-là-gì)
  * [Bậc thấp là gì?](#Bậc-thấp-là-gì)
  *  [Theory](#Theory)
  *  [Languages](#Languages)
     * [Assembly](#Assembly)
...
# Tổng quan về lập trình bậc thấp

## <a name="Nó-là-gì"></a>Nó là gì?

Tôi được truyền cảm hứng bởi [google-interview-university](https://github.com/jwasham/coding-interview-university). Tôi muốn chia sẻ kinh nghiệm và quá trình trở thành lập trình viên phần cứng bởi các kĩ năng này không còn được phổ biến như trước kia. Ngoài ra, nhiều học sinh và người mới thường hỏi tôi cách để trở thành lập trình viên phần cứng và kĩ sư Linux kernel.

Trang này không thể bao gồm tất cả link/sách/khóa học. Ví dụ như tôi chỉ giới thiều về Arduino nhưng sẽ không đua ra thông tin chi tiết về Arduino và hệ thống nhúng. Phần còn lại bạn nên tự tìm hiểu, bắt đầu từ từ khóa "Arduino". Vậy nên bước tiếp theo chắc chắn sẽ là google Arduino, đặt mua một bộ kit và tự làm một cái gì đó, thay vì chỉ tập trung vào việc tìm kiếm links hay sách miễn phí. Hãy nhớ rằng trang này chỉ là một lộ trình cho những người mới bắt đầu.

Lập trình bậc thấp là một phần của ngành khoa học máy tính.
Tất nhiên sẽ dễ dàng hơn nếu bạn đã có tìm hiểu qua về khoa học máy tính trước đó.
* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science)


## <a name="#Bậc-thấp-là-gì"></a>"Bậc thấp" là gì?

Tôi định nghĩa lập trình bậc thấp là lập trình sát với phần cứng, sử dụng các ngôn ngữ bậc thấp như C hay Assembly. Ngược lại với lập trình bậc cao, thường là các ứng dụng trong không gian người dùng, sử dụng các ngôn ngữ lập trình bậc cao(vd: Python, Java,...)
* [Wikipedia: Low-level programming language](https://en.wikipedia.org/wiki/Low-level_programming_language)

Đúng, lập trình hệ thống là một phần của lập trình bậc thấp. Trang này sẽ bao gồm các thiết kế phần cứng và firmware không nằm trong lập trình hệ thống
* [Wikipedia: System programming](https://en.wikipedia.org/wiki/System_programming)

Cuối cùng, trang này bao gồm các chủ đề từ linh kiện điện tử đến Linux kernel, bao gồm vô số đề tài. Một trang tài liệu không thể bao quát hết nội dung của đề tài đó, vậy nên mục tiêu của trang này là để tạo ra một điểm xuất phát với lập trình bậc thấp.
